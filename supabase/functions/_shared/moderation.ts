/**
 * The edge copy of src/engine/ai/moderation.ts. The two are held together by
 * src/lib/moderation-parity.test.ts: the API must not reject text the engine
 * would happily shoot, and must not pass text the engine would refuse.
 */
...
export function moderateText(content: string, checkpoint: string): ModerationVerdict {
