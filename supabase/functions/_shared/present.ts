...
const ACTION_LABELS: Record<string, string> = {
  ...
  generate_location_plate: "Build a location",
  generate_prop_still: "Build a prop",
  generate_place: "Build a place for your library",
  generate_object: "Build an object for your library",
