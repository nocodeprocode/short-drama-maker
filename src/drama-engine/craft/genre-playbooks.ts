...
export const GENRE_PLAYBOOKS: Record<GenreId, GenrePlaybook> = {
  ...
  werewolf: {
    ...
    visualMotifs: ["gold-eyes ECU", "moon", "forest edge", "claiming bite", "scent"],
    setPieces: ["rejection ritual", "hunt", "full moon", "throne", "pack hall"],
  ...
  mafia: {
    ...
    premiseTemplate:
      "{innocent or debt girl} is claimed by {don}; love is a protection racket.",
    storyDirection: "hidden_identity",
    requiredArchetypes: [
